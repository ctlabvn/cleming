...
export const cashout = (state = [], {type, payload}) => {
    switch (type) {
        case 'app/setBalanceHistory':
            if (payload.balanceConfirm.pageNumber > 1)
                payload.balanceConfirm.listBalance = {
                    ...state.balanceHistory.balanceConfirm.listBalance,
                    ...payload.balanceConfirm.listBalance
                }
